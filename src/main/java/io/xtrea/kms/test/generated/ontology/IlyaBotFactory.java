...
import io.xtrea.kms.test.generated.ontology.impl.*;
...
public class IlyaBotFactory implements CodeGenerationFactory {
     ...
     * Class http://xtrea.io/ontology/2018/4/ilyabot#Article
     ...
     /**
      * Gets an instance of type Article with the given name. Does not modify
     ...
     * Class http://xtrea.io/ontology/2018/4/ilyabot#GameMechanism
     ...
     /**
      * Creates an instance of type GameMechanism. Modifies the underlying
      * ontology.
      */
     ...
     /**
      * Gets an instance of type GameMechanism with the given name. Does not
     ...
     * Class http://xtrea.io/ontology/2018/4/ilyabot#IlyaBot
     ...
     /**
      * Gets an instance of type IlyaBot with the given name. Does not modify
      * the underlying ontology.
      *
      * @param name the name of the OWL named individual to be retrieved.
      */
     ...
     * Class http://xtrea.io/ontology/2018/4/ilyabot#NodeLinker
     ...
     /**
      * Creates an instance of type NodeLinker. Modifies the underlying
      * ontology.
      */
     ...
     /**
      * Gets an instance of type NodeLinker with the given name. Does not modify
      * the underlying ontology.
      *
      * @param name the name of the OWL named individual to be retrieved.
      */
     ...
     * Class http://xtrea.io/ontology/2018/4/ilyabot#NodeLinker_Quit
     ...
     /**
      * Creates an instance of type NodeLinker_Quit. Modifies the underlying
      * ontology.
      */
     ...
     /**
      * Gets an instance of type NodeLinker_Quit with the given name. Does not
      * modify the underlying ontology.
      *
      * @param name the name of the OWL named individual to be retrieved.
      */
     ...
     * Class http://xtrea.io/ontology/2018/4/ilyabot#NodeLinker_Random
     ...
     /**
      * Creates an instance of type NodeLinker_Random. Modifies the underlying
      * ontology.
      */
     ...
     /**
      * Gets an instance of type NodeLinker_Random with the given name. Does not
      * modify the underlying ontology.
      *
      * @param name the name of the OWL named individual to be retrieved.
      */
     ...
     * Class http://xtrea.io/ontology/2018/4/ilyabot#Node_SelectReaction
     ...
     /**
      * Creates an instance of type Node_SelectReaction. Modifies the underlying
      * ontology.
      */
     ...
     /**
      * Gets an instance of type Node_SelectReaction with the given name. Does
     ...
     * Class http://xtrea.io/ontology/2018/4/ilyabot#Node_Successive
     ...
     /**
      * Creates an instance of type Node_Successive. Modifies the underlying
      * ontology.
      */
     ...
     /**
      * Gets an instance of type Node_Successive with the given name. Does not
      * modify the underlying ontology.
      *
      * @param name the name of the OWL named individual to be retrieved.
      */
     ...
     * Class http://xtrea.io/ontology/2018/4/ilyabot#Node_Terminal
     ...
     /**
      * Creates an instance of type Node_Terminal. Modifies the underlying
      * ontology.
      */
     ...
     /**
      * Gets an instance of type Node_Terminal with the given name. Does not
      * modify the underlying ontology.
      *
      * @param name the name of the OWL named individual to be retrieved.
      */
     ...
     * Class http://xtrea.io/ontology/2018/4/ilyabot#Node_TheEnd
     ...
     /**
      * Creates an instance of type Node_TheEnd. Modifies the underlying
      * ontology.
      */
     ...
     /**
      * Gets an instance of type Node_TheEnd with the given name. Does not
      * modify the underlying ontology.
      *
      * @param name the name of the OWL named individual to be retrieved.
      */
     ...
     * Class http://xtrea.io/ontology/2018/4/ilyabot#Reaction
     ...
     /**
      * Gets an instance of type Reaction with the given name. Does not modify
      * the underlying ontology.
      *
      * @param name the name of the OWL named individual to be retrieved.
      */
     ...
     * Class http://xtrea.io/ontology/2018/4/ilyabot#Resource
     ...
     /**
      * Gets an instance of type Resource with the given name. Does not modify
      * the underlying ontology.
      *
      * @param name the name of the OWL named individual to be retrieved.
      */
     ...
     * Class http://xtrea.io/ontology/2018/4/ilyabot#Scenario
     ...
     /**
      * Gets an instance of type Scenario with the given name. Does not modify
      * the underlying ontology.
      *
      * @param name the name of the OWL named individual to be retrieved.
      */
     ...
     * Class http://xtrea.io/ontology/2018/4/ilyabot#ScenicNode
     ...
     /**
      * Creates an instance of type ScenicNode. Modifies the underlying
      * ontology.
      */
     ...
     /**
      * Gets an instance of type ScenicNode with the given name. Does not modify
      * the underlying ontology.
      *
      * @param name the name of the OWL named individual to be retrieved.
      */
     ...
     * Class http://xtrea.io/ontology/2018/4/ilyabot#ScenicNodeComponent
     ...
     /**
      * Creates an instance of type ScenicNodeComponent. Modifies the underlying
      * ontology.
      */
     ...
     /**
      * Gets an instance of type ScenicNodeComponent with the given name. Does
      * not modify the underlying ontology.
      *
      * @param name the name of the OWL named individual to be retrieved.
      */
     ...
     * Class http://xtrea.io/ontology/2018/4/ilyabot#ScenicScript
     ...
     /**
      * Creates an instance of type ScenicScript. Modifies the underlying
      * ontology.
      */
     ...
     /**
      * Gets an instance of type ScenicScript with the given name. Does not
      * modify the underlying ontology.
      *
      * @param name the name of the OWL named individual to be retrieved.
      */
