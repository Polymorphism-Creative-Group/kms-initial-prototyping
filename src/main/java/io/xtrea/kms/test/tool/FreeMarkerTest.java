...
// Wrap unchecked exceptions thrown during template processing into TemplateException-s.
          ...
          Template temp = cfg.getTemplate("scenicnode.xml");

          Map root = new HashMap();
          root.put("bot_id", UUID.randomUUID().toString());
...
//          resource1.put("img", "img001.jpg");
//          resource2.put("img", "img002.jpg");
//          resources.add(resource1);
//          resources.add(resource2);
          node.setScenario(scenario);
          System.out.println(node.getScenaio().getArticle());
          root.put("node", node);
